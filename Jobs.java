...
public class Jobs {
	...
	public Jobs(int multiple){
		 ...
		 */
		this.arrivalTime = ran1.nextInt(10)*multiple;
		this.runTime = ran2.nextInt(10)*multiple;
	...
	public static void main(String[] args) {
		...
		System.out.println("Please enter the multiple of\nhow big you want the jobs to be: ");
		int multiple = scan.nextInt();
		System.out.println("Please enter how many jobs: ");
		int input = scan.nextInt();
		Jobs[] jobs = new Jobs[input];
		for (int i = 0; i < input; i++){
			jobs[i] = new Jobs(multiple);
		}
